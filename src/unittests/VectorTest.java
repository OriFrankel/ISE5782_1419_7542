...
class VectorTest {
	...
	void testScale() {
		...
		assertThrows(IllegalArgumentException.class, () -> v1.scale(0),
				"Vector scale wrong result when the scalar is zero");
	...
	void testDotProduct() {
		...
		assertEquals(v1.dotProduct(v2), 31, 0.000000000001,
				"Vector dotProduct wrong result when the angle is an acute angle");
		// TC02: Obtuse angle
		v2 = new Vector(-4, -2, -9);
		assertEquals(v1.dotProduct(v2), -35, 0.000000000001,
				"Vector dotProduct wrong result when the angle is an obtuse angle");
		// =============== Boundary Values Tests ==================
		// TC10: Right angle
		v2 = new Vector(0, -3, 2);
		assertEquals(v1.dotProduct(v2), 0, 0.000000000001,
				"Vector dotProduct wrong result when the angle is a right angle");
	}
