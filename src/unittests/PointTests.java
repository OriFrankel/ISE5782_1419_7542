...
class PointTests {
	...
	public void testSubstract() {
		...
		assertThrows(IllegalArgumentException.class, () -> p1.subtract(p1),
				"point subtract wrong result when the difference is zero");
	}
	...
	public void testDistanceSquared() {
		...
		// =============== Boundary Values Tests ==================
		// TC10: equal points
		assertEquals(p1.distanceSquared(p1), 0, 0.0000000000001,
				"point distanceSquared wrong result when points are equal");
