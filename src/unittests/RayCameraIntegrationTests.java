...
class RayCameraIntegrationTests {
	...
	/**
	 * Test method for the integration between
	 * {@link geometries.Sphere#findIntersections(primitives.Ray)} and
	...
	/**
	 * Test method for the integration between
	 * {@link geometries.Plane#findIntersections(primitives.Ray)} and
	 * {@link renderer.Camera#constructRay(int, int, int, int)}.
	 */
	@Test
	...
	/**
	 * Test method for the integration between
	 * {@link geometries.Triangle#findIntersections(primitives.Ray)} and
	 * {@link renderer.Camera#constructRay(int, int, int, int)}.
	 */
	@Test
	void TestConstructRayAndTriangleFindIntersections() {
		...
		Camera camera = new Camera(Point.ZERO, new Vector(0, 0, -1), new Vector(0, -1, 0)).setVPDistance(1).setVPSize(3,
				3);
		Intersectable geometries = new Geometries(
